...
시각적 디자인 공간의 콘텐츠로 작업할 때 탐색 트리를 사용하여 구성 요소, 열 및 콘텐츠 요소에 액세스할 수 있습니다. 왼쪽의 _[!UICONTROL 탐색 트리]_ 아이콘(![탐색 트리 아이콘](../user-guide/assets/do-not-localize/icon-navigation-tree.svg))을 클릭하여 트리를 표시합니다.

![콘텐츠 레이어 액세스](../user-guide/content/assets/content-design-layers.png){width="800" zoomable="yes"}
...
1. 열 도구 모음에서 _[!UICONTROL 열 선택]_ 도구를 클릭하고 편집할 열을 선택합니다.
   ...
   ![비주얼 디자이너에 표시되는 열 구성 요소](../user-guide/content/assets/content-design-layers-column-select.png){width="800" zoomable="yes"}
...
1. 열 속성을 편집하려면 오른쪽의 _[!UICONTROL 스타일]_ 탭을 클릭하고 필요에 따라 변경합니다.
   ...
   * **[!UICONTROL 고급]** 섹션을 확장하여 열의 인라인 스타일을 정의합니다.
   ...
   ![선택한 열의 스타일을 변경합니다](../user-guide/content/assets/content-design-layers-column-styles.png){width="700" zoomable="yes"}
