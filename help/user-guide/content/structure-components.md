...
| ![3:1 열 아이콘](../assets/do-not-localize/icon-design-structure-3-1.png) | [!UICONTROL 3:1 열 오른쪽] | 3:1 비율을 사용하여 공간 너비를 채우는 2열 컨테이너입니다. 첫 번째(왼쪽) 열은 너비의 3/4(75%)를 차지하고 두 번째(오른쪽)는 나머지 1/4(25%)를 차지한다. |
...
![구조를 캔버스로 드래그](assets/content-design-add-structure.png){width="800" zoomable="yes"}
...
![구조 구성 요소에 대한 표시 옵션](assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![모바일에서 열을 스택하지 않음](assets/structure-component-settings-stack-columns.png){width="250"}
...
![배경색 선택기](assets/content-components-styles-background-color.png){width="300"}

#### [!UICONTROL 배경 이미지] {#background-image}

토글 선택기를 이동하여 배경 이미지 설정을 활성화합니다.

![자산 선택기를 사용한 구조 구성 요소 배경 이미지 설정](assets/structure-components-background-image-settings.png){width="250"}
...
![구조 구성 요소의 배경 이미지 배치 미리 보기](assets/structure-component-styles-background-image.png){width="250"}
...
| ![조건부 콘텐츠 사용](../assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | 조건부 콘텐츠 활성화 | (이메일 및 조각) 열에 대해 조건부 변형을 활성화합니다. |
...
* **[!UICONTROL 배경 이미지]** - 배경 이미지 설정을 활성화하려면 토글 선택기를 이동합니다.
  ...
  ![스타일 패널의 열 배경 이미지 설정](assets/structure-components-background-image-settings.png){width="250"}
...
![콘텐츠 레이어 액세스](assets/content-design-layers.png){width="800" zoomable="yes"}
...
![시각적 디자인 공간에 표시되는 열 구성 요소](assets/content-design-layers-column-select.png){width="800" zoomable="yes"}
