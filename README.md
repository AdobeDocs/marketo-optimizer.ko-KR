...
**Adobe 직원이 아닌 경우** 외부 커뮤니티 참여를 제출할 수 있습니다. 커뮤니티 기여는 Adobe 내부 시스템으로 가져와 공개 저장소에서 편집 및 병합됩니다. 그런 다음 공개 저장소가 최신 변경 사항과 동기화되고 비공개 저장소에 병합됩니다.
...
**참고:** 문서 및 코드 예제가 크게 변경된 가져오기 요청을 제출하면 온라인 참여 라이선스 계약(CLA)을 제출하라는 메시지가 가져오기 요청에 표시됩니다. 귀하의 풀 리퀘스트를 검토하기 전에 온라인 양식을 작성해 주셔야 합니다.

### 도구

커뮤니티 기여자는 기본 편집에 GitHub UI를 사용하거나 저장소를 포크하여 주요 기여를 할 수 있습니다.
...
공개 저장소에서는 풀 리퀘스트 워크플로를 관리하고 풀 리퀘스트에 무슨 일이 일어나고 있는지 알려 주기 위해 풀 리퀘스트에 자동화된 레이블이 할당됩니다.
